...
from transformers import AutoTokenizer, AutoModelForMaskedLM, get_linear_schedule_with_warmup, AdamW, BertForSequenceClassification
import numpy as np
...
from data_utils import clean_text, preprocess

# Set save path
save_path = "/project/mamonov/mali/Baylor_Project/General/Results/BertBaseUncased/"
...
def train_and_evaluate(learning_rate, batch_size):
    ...
    # Preprocess the data
    train_dataset = preprocess(train_texts, train_labels, tokenizer)
    val_dataset = preprocess(val_texts, val_labels, tokenizer)
    test_dataset = preprocess(test_texts, test_labels, tokenizer)
